...
class PayPal {
    ...
    public function create_preference($preference){
        ...
        if(isset($preference['no_shipping'])){
            $preferenceObj['no_shipping'] = $preference['no_shipping'];
        }
		
        if(isset($preference['address_override'])){
            $preferenceObj['address_override'] = $preference['address_override'];
        }
